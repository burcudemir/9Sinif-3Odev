...
a) Denkleminizi **(*x= -1.23*t^2 + 1,81*t + 5,98E-03*)**. Sizce a, b, ve c'nin fiziksel anlamları ne olabilir? (Yardım: bir tanesi ivme ile ilgili, bir tanesi ilk hız ile, diğeri konum ile ilgili).  Sizce niçin a'nın değeri negatif?
a ivmeyi b hızı c konumu ifade eder. a ivmeyi temsil etmekte olduğundan ve bu bir yavaşlayan hareket olduğundan negatiftir.

b) Hava sürtünmesini ihmal edersek, bu harakette ivme sabit midir? 
Hava sürtünmesi ihmal edilirse sadece masanın sürtünme kuvveti kalır ve bu kuvvet cisim harekete geçtiğinden sonra sabitlenir yani ivme sabitlenir.
...
1) Kendi aldığınız verileri kullanarak **ortalama hız-zaman** grafiğini Google çiziniz. [Buraya](https://docs.google.com/spreadsheets/d/1u9kwYkx07bqOQKSCBCuDuyZZasSXsumQM-KvoYavqoc/edit#gid=0) link veriniz.
...
Ne kadar kuvvet ile harekete geçtiğini bilmediğimiz için bulamazdık.
